object frmGradeTamanho: TfrmGradeTamanho
  Left = 193
  Top = 130
  BorderIcons = []
  BorderStyle = bsSingle
  Caption = 'Inclus'#227'o de Item'
  ClientHeight = 309
  ClientWidth = 576
  Color = clBtnFace
  ...
  object Panel4: TPanel
    ...
    object cmbTamanhos: TComboBox
      ...
      ItemHeight = 16
      TabOrder = 1
      OnExit = cmbTamanhosExit
      OnKeyPress = cmbTamanhosKeyPress
    end
  end
