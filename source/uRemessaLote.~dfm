object frmRemessaLote: TfrmRemessaLote
  Left = 291
  Top = 216
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Remessa por Lote'
  ClientHeight = 205
  ClientWidth = 383
  Color = clBtnFace
  ...
  object qryPedido: TQuery
    DatabaseName = 'InfoModa'
    SQL.Strings = (
      'Select PED_NRPEDI, PED_DTPEDI, PED_NRLOTE from SACPED '
      'Where (PED_NRLOTE=:pNRLOTE)')
    Left = 264
    Top = 72
    ParamData = <
      item
  ...
  object qryItens: TQuery
    ...
    SQL.Strings = (
        ...
        'Select GTM_NRPEDI, GTM_NRLOTE, GTM_CDPROD, GTM_CDTAMA, GTM_CODCO' +
        'R, GTM_QTPROD'
      'from SACGTM Where (GTM_NRLOTE=:pNRLOTE)')
    Left = 296
    Top = 72
    ParamData = <
      item
